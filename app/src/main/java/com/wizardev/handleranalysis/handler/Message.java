...
package com.wizardev.handleranalysis.handler;
...
public final class Message implements Parcelable {
    ...
    /*package*/ android.os.Message next;
     ...
     * @return A Message object from the global pool.
     */
    public static android.os.Message obtain(android.os.Handler h, Runnable callback) {
        android.os.Message m = obtain();
        m.target = h;
        m.callback = callback;
     ...
     * {@link Handler#handleMessage(android.os.Message Handler.handleMessage())}.
     */
    ...
    */
    ...
    public static final Creator<android.os.Message> CREATOR
            = new Creator<android.os.Message>() {
        public android.os.Message createFromParcel(Parcel source) {
